...
fetch('https://cors-anywhere.herokuapp.com/https://www.dropbox.com/scl/fi/jo9bqu1mfqto1l5h65z90/q_table_black.json.gz?rlkey=nf9fh3j12cagtokzqghcnztfn&st=o5qqrpzz&dl=1')
    .then(response => {
        if (!response.ok) {
